module Gen.Fetcher.Blog.Post.Post_ exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Blog", "Post", "Post_" ]


{-| submit: 
    (Result.Result Http.Error Route.Blog.Post.Post_.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Blog", "Post", "Post_" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
