module Gen.Fetcher.Blog.Page_ exposing (call_, moduleName_, submit, values_)
...
{-| submit: 
    (Result.Result Http.Error Route.Blog.Page_.ActionData -> msg)
