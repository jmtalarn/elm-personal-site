module Gen.Fetcher.Blog.Page.Page__ exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Blog", "Page", "Page__" ]


{-| submit: 
    (Result.Result Http.Error Route.Blog.Page.Page__.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Blog", "Page", "Page__" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
