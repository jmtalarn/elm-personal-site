module Gen.Fetcher.Blog.Page__ exposing (call_, moduleName_, submit, values_)
...
{-| submit: 
    (Result.Result Http.Error Route.Blog.Page__.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Blog", "Page__" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
