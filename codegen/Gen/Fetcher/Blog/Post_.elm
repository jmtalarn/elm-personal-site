module Gen.Fetcher.Blog.Post_ exposing (call_, moduleName_, submit, values_)
...
{-| submit: 
    (Result.Result Http.Error Route.Blog.Post_.ActionData -> msg)
