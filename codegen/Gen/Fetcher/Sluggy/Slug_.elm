module Gen.Fetcher.Sluggy.Slug_ exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Sluggy", "Slug_" ]


{-| submit: 
    (Result.Result Http.Error Route.Sluggy.Slug_.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Sluggy", "Slug_" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
