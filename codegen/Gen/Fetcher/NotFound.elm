module Gen.Fetcher.NotFound exposing (call_, moduleName_, submit, values_)
...
{-| submit: 
    (Result.Result Http.Error Route.NotFound.ActionData -> msg)
